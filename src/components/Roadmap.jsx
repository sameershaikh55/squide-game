							...
							<div class="cd-timeline-block">
								...
								<div class="cd-timeline-content">
									<div className="d-flex justify-content-start justify-content-lg-end w-100">
										...
										<div className="text-start text-lg-end ms-1">
											<h2 className="color1 fw600">GIFT 1 NFT VIP</h2>
											<p className="text-white">The one with front man NFT.</p>
										</div>
									</div>
									<span
										class={`d-none d-lg-block cd-date fw600 ${
								...
								<div class="cd-timeline-content">
									<div className="d-flex justify-content-start justify-content-lg-end w-100">
										...
										<div className="ms-1">
											...
											<p className="text-white">
												Drawing of 25 SOL among all persons owning a player NFT
								...
								<div class="cd-timeline-content">
									<div className="d-flex justify-content-start justify-content-lg-end w-100">
										...
										<div className="ms-1">
											...
											<p className="text-white">
												Drawing of 100 SOL among all persons owning a VIP NFT at
